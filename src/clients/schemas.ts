...
const DeploySettingsResponseSchema = z
  .object({
    create_autogenerated_releases: z
      .boolean()
      .optional()
      .describe('Whether to create autogenerated releases'),
    rollback_pipeline_definition_id: z
      .string()
      .optional()
      .describe(
        'The rollback pipeline definition ID, if configured for this project',
      ),
  })
...
export type RollbackProjectRequest = z.infer<
  typeof RollbackProjectRequestSchema
>;

export const RollbackProjectResponse = RollbackProjectResponseSchema;
export type RollbackProjectResponse = z.infer<
  typeof RollbackProjectResponseSchema
>;

export const DeploySettingsResponse = DeploySettingsResponseSchema;
export type DeploySettingsResponse = z.infer<
  typeof DeploySettingsResponseSchema
>;

export const DeployComponentsResponse = DeployComponentsResponseSchema;
export type DeployComponentsResponse = z.infer<
  typeof DeployComponentsResponseSchema
>;

export const DeployEnvironmentResponse = DeployEnvironmentResponseSchema;
export type DeployEnvironmentResponse = z.infer<
  typeof DeployEnvironmentResponseSchema
>;

export const DeployComponentVersionsResponse =
  DeployComponentVersionsResponseSchema;
export type DeployComponentVersionsResponse = z.infer<
  typeof DeployComponentVersionsResponseSchema
>;
